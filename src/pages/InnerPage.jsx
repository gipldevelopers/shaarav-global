...
const pageData = {
  about: {
    ...
    sections: [
      { tag: "Identity", heading: "A product EXIM with a modern shelf in mind.", text: "Shaarav was founded to move Indian agricultural products beyond the bulk-commodity mindset — into a category that respects design, documentation, and dependable quality.", image: spiceMarket },
      { tag: "Purpose", heading: "Make authentic Indian products easy to source.", text: "Retailers, importers, and foodservice teams need partners who think in SKUs, lead times, and consistency — not just kilos.", image: spiceMarket },
  ...
  products: {
    ...
    sections: [
      { tag: "Signature", heading: "Turmeric Powder", text: "High-curcumin, deep-golden grind. Engineered for both retail visibility and ingredient performance.", image: productTurmeric, link: "/products/turmeric-powder" },
      { tag: "Signature", heading: "Red Chilli", text: "Bright colour value, balanced heat — available across mild, medium, and hot SHU bands.", image: productChili, link: "/products/red-chilli" },
      { tag: "Signature", heading: "Coriander", text: "Fresh, citrus-green aroma. Available as seed and powder, with controlled mesh sizes.", image: productCoriander, link: "/products/coriander" },
      { tag: "Signature", heading: "Garam Masala", text: "A balanced house blend — the everyday backbone of Indian cooking, in a premium pack.", image: productGaram, link: "/products/garam-masala" },
  ...
  export: {
    ...
    sections: [
      ...
      { tag: "Packing", heading: "Retail to bulk.", text: "Retail packs, foodservice formats, bulk kraft, cartons, and pallet planning configured per buyer.", image: macroChili },
  ...
  contact: {
    ...
    sections: [
      ...
      { tag: "Requirement", heading: "What to share with us.", text: "Product name, form, quantity, pack size, destination port, and required arrival window.", image: worldMap },
