...
export const ContactWhattosharewithus = () => (
      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-12">
        <div className="lg:col-span-7 lg:order-2">
          <div className="relative">
            <div className="absolute -right-6 -top-6 hidden h-32 w-32 border border-primary/40 lg:block" />
              <img src={worldMap} alt="What to share with us." className="relative h-[64vh] w-full object-cover shadow-deep" />
          </div>
        </div>
        <div className="lg:col-span-5 lg:order-1">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">Requirement</span>
          </div>
          <h2 className="display-md mt-8 text-cocoa">What to share with us.</h2>
          <p className="mt-6 text-lg leading-relaxed text-cocoa/75">Spice name, form, quantity, pack size, destination port, and required arrival window.</p>
