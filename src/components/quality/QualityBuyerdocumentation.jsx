...
export const QualityBuyerdocumentation = () => (
      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-12">
        ...
        <div className="lg:col-span-5 order-2 lg:order-2">
          <div className="flex items-center gap-4">
            <span className="font-display text-5xl text-primary">07</span>
            <span className="h-px flex-1 bg-border" />
            <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">07</span>
          </div>
          <h2 className="display-md mt-8 text-cocoa">Buyer documentation</h2>
          <p className="mt-6 text-lg leading-relaxed text-cocoa/75">COAs, specifications, and country-specific paperwork are prepared alongside the shipment.</p>
