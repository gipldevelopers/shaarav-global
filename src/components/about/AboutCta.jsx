  ...
  <section className="section-screen bg-background">
    <div className="container-x grid items-center gap-10 lg:grid-cols-12">
      <div className="lg:col-span-8">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-relaxed text-cocoa/70">Share product details, grade, pack format, minimum order quantity, and destination — the Shaarav trade desk will respond with feasibility, sample plan, and a quote.</p>
      </div>
