...
export const AboutMakeauthenticIndianspiceeasytosource = () => (
      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-12">
        ...
        <div className="lg:col-span-5 lg:order-1">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">Purpose</span>
          </div>
          <h2 className="display-md mt-8 text-cocoa">Make authentic Indian spice easy to source.</h2>
          <p className="mt-6 text-lg leading-relaxed text-cocoa/75">Retailers, importers, and foodservice teams need partners who think in SKUs, lead times, and consistency — not just kilos.</p>
