...
export const AboutAspiceEXIMwithamodernshelfinmind = () => (
    ...
    <div className="container-x grid items-center gap-12 lg:grid-cols-12">
      <div className="lg:col-span-7 order-1 lg:order-1">
        <div className="relative">
          ...
          <img src={spiceMarket} alt="A spice EXIM with a modern shelf in mind." className="relative h-[64vh] w-full object-cover shadow-deep" />
        </div>
      </div>
      <div className="lg:col-span-5 order-2 lg:order-2">
        <div className="flex items-center gap-4">
          ...
          <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">Identity</span>
        </div>
        <h2 className="display-md mt-8 text-cocoa">A spice EXIM with a modern shelf in mind.</h2>
        <p className="mt-6 text-lg leading-relaxed text-cocoa/75">Shaarav was founded to move Indian spices beyond the bulk-commodity mindset — into a category that respects design, documentation, and dependable quality.</p>
        <div className="mt-10 flex items-center gap-3 text-xs uppercase tracking-[0.3em] text-cocoa/55">
          <span className="h-px w-8 bg-primary" />
          <span>SHAARAV · About Shaarav</span>
        </div>
      </div>
    </div>
  </section>
