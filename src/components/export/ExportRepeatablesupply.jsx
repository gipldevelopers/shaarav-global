...
export const ExportRepeatablesupply = () => (
      ...
      <div className="container-x grid items-center gap-12 lg:grid-cols-12">
        ...
        <div className="lg:col-span-5 lg:order-1">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">Consistency</span>
          </div>
          <h2 className="display-md mt-8 text-cocoa">Repeatable supply.</h2>
          <p className="mt-6 text-lg leading-relaxed text-cocoa/75">Repeat orders are anchored to grade, grind, colour, and pack-size specifications — not memory.</p>
