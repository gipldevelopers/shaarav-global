    ...
    <div className="container-x py-20 grid md:grid-cols-12 gap-10">
      <div className="md:col-span-4">
        ...
        <div className="flex gap-4 mt-6">
          <a href="https://www.instagram.com/shaarav_ent24?igsh=OXFkeXR2b3cyY2pm" target="_blank" rel="noopener noreferrer" className="p-2 border border-paper/20 hover:border-primary hover:text-primary transition" aria-label="Instagram"><Instagram size={16} /></a>
          ...
          <a href="https://www.facebook.com/share/17aDKW4dVY/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="p-2 border border-paper/20 hover:border-primary hover:text-primary transition" aria-label="Facebook"><Facebook size={16} /></a>
        </div>
      </div>
