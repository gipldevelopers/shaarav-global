...
export const ProductsSHAARAVGaramMasala = () => (
        ...
        <div className="lg:col-span-7 lg:order-2">
          <div className="relative">
            <div className="absolute -right-6 -top-6 hidden h-32 w-32 border border-primary/40 lg:block" />
              <Link to="/products/garam-masala" className="block overflow-hidden relative shadow-deep group">
                <img src={productGaram} alt="Garam Masala" className="h-[64vh] w-full object-cover transition-transform duration-700 group-hover:scale-105" />
              </Link>
          </div>
        </div>
        <div className="lg:col-span-5 lg:order-1">
          <div className="flex items-center gap-4">
            <span className="font-display text-5xl text-primary">04</span>
            <span className="h-px flex-1 bg-border" />
            <span className="text-xs uppercase tracking-[0.3em] text-cocoa/55">Signature</span>
          </div>
          <h2 className="display-md mt-8 text-cocoa">Garam Masala</h2>
          <p className="mt-6 text-lg leading-relaxed text-cocoa/75">A balanced house blend — the everyday backbone of Indian cooking, in a premium pack.</p>
            <Link to="/products/garam-masala" className="mt-8 inline-flex items-center gap-2 text-primary hover:text-cocoa transition-colors font-medium">
